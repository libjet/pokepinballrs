...
void VCountIntr(void) {
	...
	if (gMain.mainState == STATE_GAME_MAIN) {
		...
		if (gMain.unk28) {
			...
			if (gMain.vCount == 40) {
				gMain.blendControl = BLDCNT_TGT2_OBJ | BLDCNT_TGT2_BG1 | BLDCNT_TGT2_BG2 | BLDCNT_TGT2_BG3 | BLDCNT_EFFECT_BLEND | BLDCNT_TGT1_BG0;
				...
				gMain.blendControl = BLDCNT_TGT2_OBJ | BLDCNT_TGT2_BG1 | BLDCNT_TGT2_BG2 | BLDCNT_TGT2_BG3 | BLDCNT_EFFECT_NONE | BLDCNT_TGT1_BG0;
				gMain.blendAlpha = 0;
				REG_BLDCNT = gMain.blendControl;
				REG_BLDALPHA = gMain.blendAlpha;
				REG_BG0VOFS = 352;
...
static void InitGame(void) {
	REG_WAITCNT = WAITCNT_AGB | WAITCNT_PREFETCH_ENABLE | WAITCNT_PHI_OUT_NONE | WAITCNT_WS2_S_1 | WAITCNT_WS2_N_3 | WAITCNT_WS1_S_1 | WAITCNT_WS1_N_3 | WAITCNT_WS0_S_1 | WAITCNT_WS0_N_3 | WAITCNT_SRAM_2;
...
void sub_CBC(void) {
	if (!(REG_IE & INTR_FLAG_VBLANK)) {
		...
		REG_IE &= INTR_FLAG_VBLANK | INTR_FLAG_HBLANK | INTR_FLAG_VCOUNT | INTR_FLAG_TIMER0 | INTR_FLAG_TIMER1 | INTR_FLAG_TIMER2 | INTR_FLAG_TIMER3 | INTR_FLAG_SERIAL | INTR_FLAG_DMA0 | INTR_FLAG_DMA1 | INTR_FLAG_DMA2 | INTR_FLAG_DMA3 | INTR_FLAG_KEYPAD | INTR_FLAG_GAMEPAK;
		REG_IME = INTR_FLAG_VBLANK;
...
void sub_D10(void) {
	...
	REG_IE &= INTR_FLAG_VBLANK | INTR_FLAG_HBLANK | INTR_FLAG_VCOUNT | INTR_FLAG_TIMER0 | INTR_FLAG_TIMER1 | INTR_FLAG_TIMER2 | INTR_FLAG_TIMER3 | INTR_FLAG_SERIAL | INTR_FLAG_DMA0 | INTR_FLAG_DMA1 | INTR_FLAG_DMA2 | INTR_FLAG_DMA3 | INTR_FLAG_KEYPAD | INTR_FLAG_GAMEPAK;
	REG_IE &= INTR_FLAG_HBLANK | INTR_FLAG_VCOUNT | INTR_FLAG_TIMER0 | INTR_FLAG_TIMER1 | INTR_FLAG_TIMER2 | INTR_FLAG_TIMER3 | INTR_FLAG_SERIAL | INTR_FLAG_DMA0 | INTR_FLAG_DMA1 | INTR_FLAG_DMA2 | INTR_FLAG_DMA3 | INTR_FLAG_KEYPAD | INTR_FLAG_GAMEPAK;
	if (!REG_IE)
		REG_IME = 0;
